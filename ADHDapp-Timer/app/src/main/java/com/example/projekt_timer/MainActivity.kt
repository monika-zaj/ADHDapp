...
import com.example.projekt_timer.LoginActivity
import com.example.projekt_timer.databinding.ActivityLoginBinding
...
class MainActivity : AppCompatActivity() {
    ...
    /*  private fun Timer(savedInstanceState: Bundle?, ) {
          super.onCreate(savedInstanceState)
